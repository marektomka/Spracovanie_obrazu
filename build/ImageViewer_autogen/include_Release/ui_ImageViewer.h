...
public:
    ...
    void setupUi(QMainWindow *ImageViewerClass)
    {
        ...
        ImageViewerClass->resize(824, 722);
        ...
        groupBox->setGeometry(QRect(30, 10, 143, 646));
        ...
        doubleSpinBoxEpsilon = new QDoubleSpinBox(groupBox_3);
        doubleSpinBoxEpsilon->setObjectName("doubleSpinBoxEpsilon");
        doubleSpinBoxEpsilon->setAlignment(Qt::AlignCenter);
        doubleSpinBoxEpsilon->setDecimals(4);
        doubleSpinBoxEpsilon->setMinimum(0.000000000000000);
        doubleSpinBoxEpsilon->setMaximum(1.000000000000000);
        doubleSpinBoxEpsilon->setSingleStep(0.001000000000000);
        doubleSpinBoxEpsilon->setValue(0.001000000000000);

        formLayout_4->setWidget(0, QFormLayout::FieldRole, doubleSpinBoxEpsilon);

        pushButtonGMCF = new QPushButton(groupBox_3);
        pushButtonGMCF->setObjectName("pushButtonGMCF");

        formLayout_4->setWidget(1, QFormLayout::SpanningRole, pushButtonGMCF);


        verticalLayout->addWidget(groupBox_3);

        verticalSpacer_3 = new QSpacerItem(115, 28, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout->addItem(verticalSpacer_3);

        scrollArea = new QScrollArea(centralWidget);
        scrollArea->setObjectName("scrollArea");
        scrollArea->setGeometry(QRect(186, 9, 621, 651));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName("scrollAreaWidgetContents");
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 619, 649));
    ...
    void retranslateUi(QMainWindow *ImageViewerClass)
    {
        ...
        groupBox_3->setTitle(QCoreApplication::translate("ImageViewerClass", "(G)MCF", nullptr));
        label_11->setText(QCoreApplication::translate("ImageViewerClass", "Eps:", nullptr));
        pushButtonGMCF->setText(QCoreApplication::translate("ImageViewerClass", "(G)MCF", nullptr));
